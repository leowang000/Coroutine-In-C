 ...
 * @head: list head to add it prev
 *
 * Insert a new entry prev the specified head.
 ...
 * Note: list_empty on entry does not return true prev this, the entry is in an undefined state.
 */
